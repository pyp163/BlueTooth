...
public class TelnetOption
{
  ...
  public static final String getOption(int paramInt)
  {
    if (__optionString[paramInt].length() == 0)
      return "UNASSIGNED";
    return __optionString[paramInt];
  }

  public static final boolean isValidOption(int paramInt)
  {
    return paramInt <= 255;
  }
}