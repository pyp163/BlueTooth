  ...
  implements LineFormatter
{
  ...
  {
    Object localObject = paramLineFormatter;
    if (paramLineFormatter == null)
      localObject = DEFAULT;
    return ((LineFormatter)localObject).formatHeader(null, paramHeader).toString();
  }
  ...
  public static final String formatProtocolVersion(ProtocolVersion paramProtocolVersion, LineFormatter paramLineFormatter)
  {
    ...
    if (paramLineFormatter == null)
      localObject = DEFAULT;
    return ((LineFormatter)localObject).appendProtocolVersion(null, paramProtocolVersion).toString();
  }
  ...
  public static final String formatRequestLine(RequestLine paramRequestLine, LineFormatter paramLineFormatter)
  {
    ...
    if (paramLineFormatter == null)
      localObject = DEFAULT;
    return ((LineFormatter)localObject).formatRequestLine(null, paramRequestLine).toString();
  }
  ...
  public static final String formatStatusLine(StatusLine paramStatusLine, LineFormatter paramLineFormatter)
  {
    ...
    if (paramLineFormatter == null)
      localObject = DEFAULT;
    return ((LineFormatter)localObject).formatStatusLine(null, paramStatusLine).toString();
  }
