...
public class ImageRequestBuilder
{
  ...
  protected void validate()
  {
    ...
    try
    {
      ...
      break label101;
      label90: throw new BuilderException("Resource URI path must be a resource id.");
      label101: if ((UriUtil.isLocalAssetUri(this.mSourceUri)) && (!this.mSourceUri.isAbsolute()))
