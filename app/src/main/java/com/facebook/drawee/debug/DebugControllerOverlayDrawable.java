  ...
  implements ImageLoadingTimeListener
{
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    if (this.mImageId != null)
      addDebugText(paramCanvas, "IDs: %s, %s", new Object[] { this.mControllerId, this.mImageId });
    else
    ...
    if (this.mFinalImageTimeMs >= 0L)
      addDebugText(paramCanvas, "t: %d ms", new Object[] { Long.valueOf(this.mFinalImageTimeMs) });
  }
