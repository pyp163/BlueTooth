...
public class TypeToken<T>
{
  ...
  public static TypeToken<?> getParameterized(Type paramType, Type[] paramArrayOfType)
  {
    return new TypeToken(.Gson.Types.newParameterizedTypeWithOwner(null, paramType, paramArrayOfType));
  }
