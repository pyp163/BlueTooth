  ...
  implements Closeable
{
    ...
    throws IOException
  {
    int j = 0;
    Object localObject1 = null;
    label204: label207: Object localObject2;
    do
    {
      i = 0;
      do
    ...
    throws IOException
  {
    ...
    while (true)
    {
      ...
      default:
        ...
        if (!isLiteral(c))
        {
          if ((i == 2) && (bool1) && ((l1 != -9223372036854775808L) || (k != 0)) && ((l1 != 0L) || (k == 0)))
          {
            if (k == 0)
              l1 = -l1;
            this.peekedLong = l1;
              ...
              if (c != 'r')
              {
                ...
                case 'u':
                  ...
                  while (i < j + 4)
                  {
                    ...
                    i += 1;
                    continue;
                    label286: localObject = new StringBuilder();
    ...
    throws IOException
  {
    ...
    this.peeked = 9;
    return 9;
    label489: this.stack[(this.stackSize - 1)] = 4;
    if (i == 5)
    {
      j = nextNonWhitespace(true);
      if (j != 44)
    ...
    throws IOException
  {
    ...
    return localObject;
    label78: Object localObject = new StringBuilder();
    ...
    throws IOException
  {
    ...
    arrayOfInt[i] += 1;
    return localObject;
    label167: Object localObject = new StringBuilder();
