...
public class GPNormalKey
  implements Serializable
{
  private static final long serialVersionUID = 551954659279840814L;
  private byte code;
  private byte p1xh;
  private byte p1xl;
  private byte p1yh;
  ...
  public GPNormalKey(byte paramByte1, byte paramByte2, byte paramByte3, byte paramByte4, byte paramByte5, byte paramByte6, byte paramByte7, byte paramByte8, byte paramByte9, byte paramByte10)
  {
