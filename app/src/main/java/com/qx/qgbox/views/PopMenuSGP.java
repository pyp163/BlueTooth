...
public class PopMenuSGP
{
  ...
  public PopMenuSGP(Context paramContext, int paramInt)
  {
  ...
  private int getMaxWidth(ListView paramListView)
  {
    ...
    for (int j = 220; i < m; j = k)
    {
      ...
      localView.measure(View.MeasureSpec.makeMeasureSpec(0, MeasureSpec.UNSPECIFIED), View.MeasureSpec.makeMeasureSpec(0, MeasureSpec.UNSPECIFIED));
      k = j;
  ...
  private final class PopAdapter extends BaseAdapter
  {
    ...
    public int getCount()
    {
      return PopMenuSGP.this.itemList.size();
    }

    public Object getItem(int paramInt)
    {
      return PopMenuSGP.this.itemList.get(paramInt);
    }
    ...
    public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
    {
      if (paramView == null)
      {
        paramView = LayoutInflater.from(PopMenuSGP.this.context).inflate(R.layout.popmenu_item1, null);
      ...
      paramViewGroup.groupItem.setText(((PopMenuSGP.Item)PopMenuSGP.this.itemList.get(paramInt)).text);
      paramViewGroup.groupImg.setBackgroundResource(((PopMenuSGP.Item)PopMenuSGP.this.itemList.get(paramInt)).id);
      return paramView;
    }
