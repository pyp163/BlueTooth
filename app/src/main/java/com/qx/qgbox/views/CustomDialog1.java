...
{
  public CustomDialog1(Context paramContext)
  {
    super(paramContext);
  }

  public CustomDialog1(Context paramContext, int paramInt)
  {
  ...
  public static class Builder
  {
    ...
    public CustomDialog1 create()
    {
      ...
      final CustomDialog1 localCustomDialog1 = new CustomDialog1(this.context, R.style.mystyle);
      localObject = ((LayoutInflater)localObject).inflate(R.layout.customdialog1, null);
      localCustomDialog1.addContentView((View)localObject, new ViewGroup.LayoutParams(-1, -2));
      ...
      if ((this.neutral_btnText != null) && (this.confirm_btnText != null) && (this.cancel_btnText != null))
      {
        ...
        if (this.neutral_btnClickListener != null)
          ((Button)((View)localObject).findViewById(R.id.neutral_btn)).setOnClickListener(new View.OnClickListener()
          {
            ...
            {
              CustomDialog1.Builder.this.neutral_btnClickListener.onClick(localCustomDialog1, -3);
            }
          });
        else
          ((Button)((View)localObject).findViewById(R.id.neutral_btn)).setOnClickListener(new View.OnClickListener()
      ...
      {
        ((View)localObject).findViewById(R.id.neutral_btn).setVisibility(8);
        ((View)localObject).findViewById(R.id.single_line).setVisibility(8);
      }
      if (this.confirm_btnText != null)
      {
        ...
        if (this.confirm_btnClickListener != null)
          ((Button)((View)localObject).findViewById(R.id.confirm_btn)).setOnClickListener(new View.OnClickListener()
          {
            public void onClick(View paramAnonymousView)
            {
              CustomDialog1.Builder.this.confirm_btnClickListener.onClick(localCustomDialog1, -1);
            }
          });
        else
          ((Button)((View)localObject).findViewById(R.id.confirm_btn)).setOnClickListener(new View.OnClickListener()
      ...
      {
        ((View)localObject).findViewById(R.id.confirm_btn).setVisibility(8);
        ((View)localObject).findViewById(R.id.second_line).setVisibility(8);
      ...
      if (this.cancel_btnText != null)
      {
        ...
        if (this.cancel_btnClickListener != null)
          ((Button)((View)localObject).findViewById(R.id.cancel_btn)).setOnClickListener(new View.OnClickListener()
          {
            public void onClick(View paramAnonymousView)
            {
              CustomDialog1.Builder.this.cancel_btnClickListener.onClick(localCustomDialog1, -2);
            }
          });
        else
          ((Button)((View)localObject).findViewById(R.id.cancel_btn)).setOnClickListener(new View.OnClickListener()
      ...
      {
        ((View)localObject).findViewById(R.id.cancel_btn).setVisibility(8);
        ((View)localObject).findViewById(R.id.second_line).setVisibility(8);
      ...
      localCustomDialog1.setContentView((View)localObject);
      return localCustomDialog1;
    }
    ...
    {
      this.confirm_btnText = ((String)this.context.getText(paramInt));
