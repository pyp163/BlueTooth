  ...
  implements Cloneable, Call.Factory, WebSocket.Factory
{
  ...
  static
  {
    ...
    Internal.instance = new Internal()
    {
      ...
      @Nullable
      public Exchange exchange(Response paramAnonymousResponse)
      {
        return paramAnonymousResponse.exchange;
      }

      public void initExchange(Response.Builder paramAnonymousBuilder, Exchange paramAnonymousExchange)
      {
        paramAnonymousBuilder.initExchange(paramAnonymousExchange);
      }
      ...
      public RealConnectionPool realConnectionPool(ConnectionPool paramAnonymousConnectionPool)
      {
        return paramAnonymousConnectionPool.delegate;
      }
    };
  }
  ...
  OkHttpClient(Builder paramBuilder)
  {
    ...
    label155: if ((paramBuilder.sslSocketFactory == null) && (i != 0))
    {
  ...
  public static final class Builder
  {
    ...
    public Builder socketFactory(SocketFactory paramSocketFactory)
    {
      ...
      if ((paramSocketFactory instanceof SSLSocketFactory))
