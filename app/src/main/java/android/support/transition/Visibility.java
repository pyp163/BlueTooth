...
public abstract class Visibility extends Transition
{
  ...
  public Animator onDisappear(ViewGroup paramViewGroup, TransitionValues paramTransitionValues1, int paramInt1, TransitionValues paramTransitionValues2, int paramInt2)
  {
    ...
    while (true)
    {
      localObject2 = null;
      break label264;
      label132: if (localObject2 == null)
        break;
      if (((View)localObject2).getParent() == null)
      {
        label145: localObject1 = localObject2;
      }
      else
      {
        ...
        else if (((View)localObject1).getParent() == null)
        {
    ...
    label264: if ((localObject1 != null) && (paramTransitionValues1 != null))
    {
