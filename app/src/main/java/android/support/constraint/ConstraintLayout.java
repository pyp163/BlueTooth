...
public class ConstraintLayout extends ViewGroup
{
  ...
  private void init(AttributeSet paramAttributeSet)
  {
    ...
    if (paramAttributeSet != null)
    {
      ...
      j = paramAttributeSet.getIndexCount();
      i = 0;
    }
    while (true)
    {
      ...
      try
      {
        ...
        break label234;
        label229: this.mConstraintSet = null;
        label234: this.mConstraintSetId = k;
        i += 1;
        continue;
    ...
    while (i4 < i3)
    {
      ...
      if (localView.getVisibility() != 8)
      {
        ...
        else
        {
          ...
          label1046: localView.measure(m, i1);
          if (this.mMetrics != null)
          {
            localObject = this.mMetrics;
            ((Metrics)localObject).measures += 1L;
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    {
      if ((this.mLayoutWidget.mHorizontalWrapOptimized) && (m == -2147483648))
      {
                ...
                if (i8 != ((ConstraintWidget)localObject).getHeight())
                {
                  ...
                  if (i3 != 0)
                  {
                    ...
                    if (((ConstraintWidget)localObject).getBottom() > i)
                      k = Math.max(i, ((ConstraintWidget)localObject).getBottom() + ((ConstraintWidget)localObject).getAnchor(ConstraintAnchor.Type.BOTTOM).getMargin());
                  }
                  n = 1;
                }
                i = n;
              ...
              catch (Exception paramAttributeSet)
              {
                try
                {
                  while (true)
                  {
                    ...
                    break label2032;
                    label1142: if (paramContext.getInt(j, this.matchConstraintMinWidth) == -2)
                    {
