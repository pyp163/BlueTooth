    ...
    public boolean equals(@Nullable Object paramObject)
    {
      ...
      if (paramObject != null)
      {
        ...
        if (this.mWrapped != null)
          return this.mWrapped.equals(paramObject.mWrapped);
        if (Build.VERSION.SDK_INT >= 23)
        {
          if (this.mBreakStrategy != paramObject.getBreakStrategy())
            return false;
          if (this.mHyphenationFrequency != paramObject.getHyphenationFrequency())
            return false;
        }
        if ((Build.VERSION.SDK_INT >= 18) && (this.mTextDir != paramObject.getTextDirection()))
          return false;
        if (this.mPaint.getTextSize() != paramObject.getTextPaint().getTextSize())
          return false;
        if (this.mPaint.getTextScaleX() != paramObject.getTextPaint().getTextScaleX())
          return false;
        if (this.mPaint.getTextSkewX() != paramObject.getTextPaint().getTextSkewX())
          return false;
        if (Build.VERSION.SDK_INT >= 21)
        {
          if (this.mPaint.getLetterSpacing() != paramObject.getTextPaint().getLetterSpacing())
            return false;
          if (!TextUtils.equals(this.mPaint.getFontFeatureSettings(), paramObject.getTextPaint().getFontFeatureSettings()))
            return false;
        }
        if (this.mPaint.getFlags() != paramObject.getTextPaint().getFlags())
          return false;
        if (Build.VERSION.SDK_INT >= 24)
        {
          if (!this.mPaint.getTextLocales().equals(paramObject.getTextPaint().getTextLocales()))
            return false;
        }
        else if ((Build.VERSION.SDK_INT >= 17) && (!this.mPaint.getTextLocale().equals(paramObject.getTextPaint().getTextLocale())))
          return false;
        ...
        else if (!this.mPaint.getTypeface().equals(paramObject.getTextPaint().getTypeface()))
          return false;
        return true;
      }
      return false;
