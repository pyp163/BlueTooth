...
public class NotificationCompat
{
  ...
  public static class Builder
  {
    ...
    private Bitmap reduceLargeIconSize(Bitmap paramBitmap)
    {
      if (paramBitmap != null)
      {
        ...
        return Bitmap.createScaledBitmap(paramBitmap, (int)Math.ceil(paramBitmap.getWidth() * d), (int)Math.ceil(paramBitmap.getHeight() * d), true);
      }
      return paramBitmap;
    }
    ...
    public static final class Message
    {
      ...
      static Message getMessageFromBundle(Bundle paramBundle)
      {
        while (true)
        {
          ...
          label195: Object localObject = null;
        }
      }
  ...
  public static abstract class Style
  {
    ...
    public RemoteViews applyStandardTemplate(boolean paramBoolean1, int paramInt, boolean paramBoolean2)
    {
      ...
      Object localObject = this.mBuilder.mLargeIcon;
      int k = 8;
      int i;
      if (localObject != null)
      {
      ...
      label661: if ((this.mBuilder.mSubText != null) && (Build.VERSION.SDK_INT >= 16))
      {
