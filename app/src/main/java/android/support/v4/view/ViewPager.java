...
public class ViewPager extends ViewGroup
{
  ...
  public boolean arrowScroll(int paramInt)
  {
    ...
    label198: localView1 = FocusFinder.getInstance().findNextFocus(this, (View)localObject, paramInt);
    int j;
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    if ((this.mPageMargin > 0) && (this.mMarginDrawable != null) && (this.mItems.size() > 0) && (this.mAdapter != null))
    {
      ...
      while (i < i1)
      {
        ...
        {
          f3 = ((ItemInfo)localObject).offset;
          float f6 = ((ItemInfo)localObject).widthFactor;
          f1 = ((ItemInfo)localObject).offset;
  ...
  void populate(int paramInt)
  {
    ...
    try
    {
      ...
      break label144;
      label135: localObject1 = Integer.toHexString(getId());
      label144: localObject2 = new StringBuilder();
      ...
      localObject1 = null;
      label323: Object localObject3 = localObject1;
