...
public final class ViewConfigurationCompat
{
  ...
  static
  {
    ...
    try
    {
      ...
      return;
      label23: Log.i("ViewConfigCompat", "Could not find method getScaledScrollFactor() on ViewConfiguration");
      return;
    }
  ...
  private static float getLegacyScrollFactor(ViewConfiguration paramViewConfiguration, Context paramContext)
  {
    ...
    try
    {
      ...
      return i;
      label35: Log.i("ViewConfigCompat", "Could not find method getScaledScrollFactor() on ViewConfiguration");
