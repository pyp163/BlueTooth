...
public final class TextViewCompat
{
  ...
  private static Field retrieveField(String paramString)
  {
    ...
    catch (NoSuchFieldException localNoSuchFieldException1)
    {
      try
      {
        ...
        {
          localField = null;
          label16: StringBuilder localStringBuilder = new StringBuilder();
  ...
  private static int retrieveIntFromField(Field paramField, TextView paramTextView)
  {
    try
    {
      ...
      return i;
      label8: paramTextView = new StringBuilder();
    ...
    implements ActionMode.Callback
  {
    ...
    private void recomputeProcessTextMenuItems(Menu paramMenu)
    {
      ...
      catch (ClassNotFoundException|NoSuchMethodException localClassNotFoundException)
      {
        try
        {
          label83: if ((this.mCanUseMenuBuilderReferences) && (this.mMenuBuilderClass.isInstance(paramMenu)))
