...
{
  private static final float CORNER_RADIUS_ADJUSTMENT = 1.0E-005F;
  private static final int DEFAULT_BACKGROUND_COLOR = -1;
  private static final boolean IS_LOLLIPOP = bool;
  ...
  private Drawable createBackgroundCompat()
  {
    ...
    this.colorableBackgroundDrawableCompat.setCornerRadius(this.cornerRadius + 1.0E-005F);
    ...
    this.rippleDrawableCompat.setCornerRadius(this.cornerRadius + 1.0E-005F);
  ...
  private Drawable createBackgroundLollipop()
  {
    ...
    this.backgroundDrawableLollipop.setCornerRadius(this.cornerRadius + 1.0E-005F);
    this.backgroundDrawableLollipop.setColor(-1);
    updateTintAndTintModeLollipop();
    this.strokeDrawableLollipop = new GradientDrawable();
    this.strokeDrawableLollipop.setCornerRadius(this.cornerRadius + 1.0E-005F);
    ...
    this.maskDrawableLollipop.setCornerRadius(this.cornerRadius + 1.0E-005F);
