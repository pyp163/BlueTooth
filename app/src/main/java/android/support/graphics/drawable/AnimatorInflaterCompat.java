...
public class AnimatorInflaterCompat
{
    ...
    throws XmlPullParserException, IOException
  {
      ...
      if (k == 2)
      {
        ...
        while (true)
        {
          ...
          else if (((String)localObject1).equals("set"))
          {
            ...
            i = TypedArrayUtils.getNamedInt((TypedArray)localObject3, paramXmlPullParser, "ordering", 0, 0);
    ...
    label304: paramContext = new StringBuilder();
    ...
    label342: if ((paramAnimatorSet != null) && (localObject2 != null))
    {
