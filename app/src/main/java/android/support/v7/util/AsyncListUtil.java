...
public class AsyncListUtil<T>
{
  ...
  private final ThreadUtil.BackgroundCallback<T> mBackgroundCallback = new ThreadUtil.BackgroundCallback()
  {
    ...
    private void log(String paramAnonymousString, Object[] paramAnonymousArrayOfObject)
    {
      StringBuilder localStringBuilder = new StringBuilder();
      localStringBuilder.append("[BKGR] ");
      localStringBuilder.append(String.format(paramAnonymousString, paramAnonymousArrayOfObject));
  ...
  void log(String paramString, Object[] paramArrayOfObject)
  {
    ...
    localStringBuilder.append(String.format(paramString, paramArrayOfObject));
    Log.d("AsyncListUtil", localStringBuilder.toString());
  }
