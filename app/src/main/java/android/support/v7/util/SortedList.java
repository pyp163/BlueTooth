...
public class SortedList<T>
{
  ...
  private void merge(T[] paramArrayOfT, int paramInt)
  {
    ...
    while (true)
    {
      ...
      if (j != 0)
        endBatchedUpdates();
      return;
      label229: Object localObject1 = this.mOldData[this.mOldDataStart];
  ...
  private void replaceAllInternal(@NonNull T[] paramArrayOfT)
  {
    ...
    while (true)
    {
      ...
      if (i != 0)
        endBatchedUpdates();
      return;
      label215: Object localObject = this.mOldData[this.mOldDataStart];
  ...
  public void addAll(@NonNull T[] paramArrayOfT)
  {
  ...
  public void replaceAll(@NonNull T[] paramArrayOfT)
  {
    replaceAll(paramArrayOfT, false);
  }
