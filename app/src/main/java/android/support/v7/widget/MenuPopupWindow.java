  ...
  implements MenuItemHoverListener
{
  ...
  static
  {
    try
    {
      ...
      return;
      label21: Log.i("MenuPopupWindow", "Could not find method setTouchModal() on PopupWindow. Oh well.");
      return;
    }
  ...
  public void setTouchModal(boolean paramBoolean)
  {
    ...
    try
    {
      ...
      return;
      label29: Log.i("MenuPopupWindow", "Could not invoke setTouchModal() on PopupWindow. Oh well.");
      return;
    }
