  ...
  implements RecyclerView.SmoothScroller.ScrollVectorProvider
{
  ...
  private void handleUpdate(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    int k = i;
    int i = paramInt1;
    label64: this.mLazySpanLookup.invalidateAfter(i);
    if (paramInt3 != 8)
    {
      switch (paramInt3)
      {
  ...
  private void onLayoutChildren(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState, boolean paramBoolean)
  {
    ...
    int i = 0;
    label674: if (paramState.isPreLayout())
  ...
  public int[] findFirstCompletelyVisibleItemPositions(int[] paramArrayOfInt)
  {
    ...
    {
      localObject = new int[this.mSpanCount];
    }
    else
    {
      ...
      if (paramArrayOfInt.length < this.mSpanCount)
      {
        ...
        ((StringBuilder)localObject).append("Provided int[]'s size must be more than or equal to span count. Expected:");
        ((StringBuilder)localObject).append(this.mSpanCount);
        ((StringBuilder)localObject).append(", array size:");
    ...
    while (i < this.mSpanCount)
    {
      localObject[i] = this.mSpans[i].findFirstCompletelyVisibleItemPosition();
      i += 1;
    }
    return localObject;
  }
  ...
  public int[] findFirstVisibleItemPositions(int[] paramArrayOfInt)
  {
    ...
    while (i < this.mSpanCount)
    {
      localObject[i] = this.mSpans[i].findFirstVisibleItemPosition();
      i += 1;
    }
    return localObject;
  }
  ...
  public int[] findLastCompletelyVisibleItemPositions(int[] paramArrayOfInt)
  {
    ...
    while (i < this.mSpanCount)
    {
      localObject[i] = this.mSpans[i].findLastCompletelyVisibleItemPosition();
      i += 1;
    }
    return localObject;
  }
  ...
  public int[] findLastVisibleItemPositions(int[] paramArrayOfInt)
  {
    ...
    while (i < this.mSpanCount)
    {
      localObject[i] = this.mSpans[i].findLastVisibleItemPosition();
      i += 1;
    }
    return localObject;
  }
