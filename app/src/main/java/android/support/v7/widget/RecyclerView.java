  ...
  implements ScrollingView, NestedScrollingChild2
{
  ...
  private static final boolean IGNORE_DETACHED_FOCUSED_CHILD = bool;
  ...
  public boolean onGenericMotionEvent(MotionEvent paramMotionEvent)
  {
    ...
    if (paramMotionEvent.getAction() == 8)
    {
      ...
      label138: float f2 = 0.0F;
      label140: if ((f1 != 0.0F) || (f2 != 0.0F))
  ...
  public static abstract class LayoutManager
  {
    ...
    public static int getChildMeasureSpec(int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean)
    {
      ...
      label125: return View.MeasureSpec.makeMeasureSpec(paramInt3, paramInt1);
    }
    ...
    public static int getChildMeasureSpec(int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
    {
      ...
      label59: return View.MeasureSpec.makeMeasureSpec(paramInt1, paramInt2);
    }
  ...
  public final class Recycler
  {
    ...
    RecyclerView.ViewHolder tryGetViewHolderForPositionByDeadline(int paramInt, boolean paramBoolean, long paramLong)
    {
      if ((paramInt >= 0) && (paramInt < RecyclerView.this.mState.getItemCount()))
      {
        ...
        int j = 0;
        Object localObject2 = localObject1;
        label73: localObject1 = localObject2;
        int i = j;
        if (localObject2 == null)
        {
        ...
        j = k;
        label771: if ((j != 0) && (!RecyclerView.this.mState.isPreLayout()) && (((RecyclerView.ViewHolder)localObject2).hasAnyOfTheFlags(8192)))
        {
        ...
        paramBoolean = false;
        break label954;
        label934: paramBoolean = tryBindViewHolderByDeadline((RecyclerView.ViewHolder)localObject2, RecyclerView.this.mAdapterHelper.findPositionOffset(paramInt), paramInt, paramLong);
        label954: localObject1 = ((RecyclerView.ViewHolder)localObject2).itemView.getLayoutParams();
        if (localObject1 == null)
        {
