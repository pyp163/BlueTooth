  ...
  implements ShowableListMenu
{
  ...
  static
  {
    ...
    catch (NoSuchMethodException localNoSuchMethodException2)
    {
      try
      {
        label31: sGetMaxAvailableHeightMethod = PopupWindow.class.getDeclaredMethod("getMaxAvailableHeight", new Class[] { View.class, Integer.TYPE, Boolean.TYPE });
        break label73;
      ...
      catch (NoSuchMethodException localNoSuchMethodException2)
      {
        try
        {
          while (true)
          {
            label73: sSetEpicenterBoundsMethod = PopupWindow.class.getDeclaredMethod("setEpicenterBounds", new Class[] { Rect.class });
            return;
            label93: Log.i("ListPopupWindow", "Could not find method setEpicenterBounds(Rect) on PopupWindow. Oh well.");
            return;
  ...
  private int getMaxAvailableHeight(View paramView, int paramInt, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      return i;
      label49: Log.i("ListPopupWindow", "Could not call getMaxAvailableHeightMethod(View, int, boolean) on PopupWindow. Using the public version.");
  ...
  private void setPopupClipToScreenEnabled(boolean paramBoolean)
  {
    ...
    try
    {
      ...
      return;
      label29: Log.i("ListPopupWindow", "Could not call setClipToScreenEnabled() on PopupWindow. Oh well.");
      return;
    }
    catch (Exception localException)
    {
